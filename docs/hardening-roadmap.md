...
| P2 | Split packed-consumer verification into a lock-pinned baseline lane and an explicit floating compatibility lane. | Done | `hardening/p2-consumer-compat-lanes` | `cb774da0e08421dfd13b52d4415e9b2e270de8ee` |
